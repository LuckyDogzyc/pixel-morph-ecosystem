...
本计划用于实现大地图分区生态与地形碰撞，并统一场景 tileset 风格为宝可梦彩色像素时代（参考 GBA/早期 DS 的精致像素场景质感）。

## Feature Description

- 构建大地图与区块化生态
- 引入 tile-based 地形（草地/水域/桥/墙/城市/树/花/岩石/栅栏/屋顶/墙体）
...
目前场景只有简单背景，缺少地形与区块概念，无法体现生态区差异，也不符合“宝可梦彩色像素时代”精致像素风的视觉统一要求。
